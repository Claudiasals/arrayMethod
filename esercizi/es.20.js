...
const count = logs.reduce((acc, obj) => {
  if (!acc[obj.action]) {
    acc[obj.action] = 0
  }
  acc[obj.action]++;
...
/*
data = tutti gli oggetti presenti nell Array
limit = quanti elementi vogliamo avere per paginateData
...
// [...data] --> fa una copia di data
// .slice --> prende una porzione di data
